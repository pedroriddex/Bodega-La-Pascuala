...
const bocadillos = [
  ...
  },
  {
    ...
    fullSize: 13,
    description:
      'Sobrasada a la plancha, pechuga de pollo, cebolla frita y miel.',
  },
  {
    title: 'Javi',
    halfSize: 8,
  ...
  },
  {
    ...
    fullSize: 13.5,
    description:
      'Pechuga de pollo, queso de rulo de cabra, cebolla frita y bacon.',
  },
  {
    title: 'Bluetooth',
    halfSize: 7.25,
  ...
  },
  {
    ...
    fullSize: 13.5,
    description:
      '4 hamburguesas de caballo de 70gr, cebolla deshidratada crujiente, queso y bacon.',
  },
  {
...
export async function main() {
  ...
  requireEnv('SANITY_API_WRITE_TOKEN', process.env.SANITY_API_WRITE_TOKEN)
  ...
  for (const bocadillo of bocadillos) {
    ...
    if (!options.dryRun) {
      const assetId = await getImageAssetId(
        client,
        imageInfo,
        assetCache,
        options.forceUpload,
