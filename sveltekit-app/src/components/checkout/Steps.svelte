...
<div class="flex items-center justify-between mb-8 p-4 relative">
	<!-- Connecting Line -->
	<div class="absolute top-1/2 left-0 w-full h-1 bg-gray-100 -z-10 rounded-full">
		<div
			class="h-full bg-[#214593] transition-all duration-300 rounded-full"
	...
	{#each steps as step, i}
		<div class="flex flex-col items-center gap-2 bg-white px-2">
			<div
                ...
                {i <= currentStep
					? 'border-[#214593] bg-[#214593] text-white'
