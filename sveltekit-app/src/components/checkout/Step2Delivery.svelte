...
<div class="space-y-8 animate-fade-in">
	<div class="grid grid-cols-2 gap-4">
		<label
            ...
            {data.method === 'pickup'
				? 'border-brand-blue bg-blue-50/50 text-brand-blue ring-1 ring-brand-blue/20'
		...
		>
			...
			<div class="p-3 rounded-full {data.method === 'pickup' ? 'bg-white' : 'bg-gray-50 group-hover:bg-blue-50'} transition-colors">
		...
		>
			...
			<div class="p-3 rounded-full {data.method === 'delivery' ? 'bg-white' : 'bg-gray-50 group-hover:bg-blue-50'} transition-colors">
	...
	{#if data.method === 'delivery'}
		<div class="space-y-6 pt-6 border-t border-gray-100">
			<div class="space-y-2">
				<label for="address" class="block text-sm font-bold text-gray-700 tracking-wide uppercase">Dirección</label>
				<input
					type="text"
					id="address"
			...
			<div class="grid grid-cols-2 gap-6">
				<div class="space-y-2">
					<label for="city" class="block text-sm font-bold text-gray-700 tracking-wide uppercase">Ciudad</label>
					<input
						type="text"
						id="city"
				...
				<div class="space-y-2">
					<label for="zip" class="block text-sm font-bold text-gray-700 tracking-wide uppercase">Código Postal</label>
					<input
						type="text"
						id="zip"
						bind:value={data.zip}
			...
			<div class="flex items-center gap-3 pt-4">
				...
				/>
				<label for="saveAddress" class="text-sm font-medium text-gray-600 cursor-pointer select-none">
